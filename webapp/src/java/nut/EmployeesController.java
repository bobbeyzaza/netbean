...
import nut.util.JsfUtil;
import nut.util.PaginationHelper;
...
public class EmployeesController implements Serializable {
    ...
    @EJB
    private nut.EmployeesFacade ejbFacade;
    ...
    public Employees getSelected() {
        if (current == null) {
            ...
            current.setEmployeesPK(new nut.EmployeesPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public Employees getEmployees(nut.EmployeesPK id) {
    ...
    public static class EmployeesControllerConverter implements Converter {
        ...
        nut.EmployeesPK getKey(String value) {
            nut.EmployeesPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new nut.EmployeesPK();
        ...
        String getStringKey(nut.EmployeesPK value) {
